...
public class AndroidLame {
    ...
    private void initialize(LameBuilder builder) {
        initialize(builder.getInSampleRate(), builder.getOutChannel(), builder.getOutSampleRate(),
                builder.getOutBitrate(), builder.getScaleInput(), getIntForMode(builder.getMode()), getIntForVbrMode(builder.getVbrMode()), builder.getQuality(),
                builder.getVbrQuality(), builder.getAbrMeanBitrate(),
                builder.getLowpassFreq(), builder.getHighpassFreq(), builder.getId3tagTitle(), builder.getId3tagArtist(),
                builder.getId3tagAlbum(), builder.getId3tagYear(), builder.getId3tagComment());
    }
